...
* `map(html_node, "#raw-url")` tells `r fontawesome::fa("r-project", fill = "steelblue", height = 20)` to look for the url associated with the download button for each cheatsheet. You identify this tag by using the Google's Selector Gadget---search it for examples and how to identify tags.
